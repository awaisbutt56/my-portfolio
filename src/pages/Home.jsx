...
const Home = () => {
  ...
  const [currentStep, setCurrentStep] = useState(1); // Next pages handle karne ke liye
  ...
  return (
    // relative class yahan zaroori hai taake absolute animation iske andar rahe
    <main className="min-h-screen bg-[#050505] relative overflow-hidden w-full">
      ...
      <div className="relative z-10 w-full h-screen flex items-center justify-center">
        {/* Step logic: Jab bhabhi click karein gi to agla page show hoga */}
        {currentStep === 1 && (
